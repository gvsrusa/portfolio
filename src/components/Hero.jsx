    ...
    return (
        <section id="hero" className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden pt-20">
            ...
            <div className={`text-center z-10 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                ...
                <p className="max-w-xl mx-auto text-slate-400 text-lg md:text-xl leading-relaxed mb-10 px-6">
                    Building digital experiences with clean code and modern design.
                    Specialized in high-performance web applications.
                </p>

                <div className="flex justify-center space-x-6">
                    <a href="https://github.com/gvsrusa" target="_blank" rel="noreferrer" className="group flex items-center gap-2 px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-full transition-all border border-slate-700 hover:border-sky-500">
                        <svg className="w-5 h-5 group-hover:text-sky-400 transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://www.linkedin.com/in/gvsrusa/" target="_blank" rel="noreferrer" className="group flex items-center gap-2 px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-full transition-all border border-slate-700 hover:border-sky-500">
                        <svg className="w-5 h-5 group-hover:text-sky-400 transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
