...
const Hero = () => {
    ...
    return (
        <section id="hero" className="min-h-screen flex items-center relative overflow-hidden pt-36 md:pt-20 px-6">
            ...
            <div className="absolute top-1/4 right-0 w-[300px] h-[300px] bg-sky-500/10 rounded-full blur-[80px] -z-10"></div>

            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
                {/* Text Content - Left Side */}
                <div className={`max-w-2xl text-left transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>

                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-sm text-slate-300 mb-8 backdrop-blur-sm">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 justify-start">
                        <a
                            href="#projects"
                            className="px-8 py-4 bg-white text-black rounded-full font-medium hover:bg-slate-200 transition-colors w-full sm:w-auto text-center"
                        >
                            View Projects
                        </a>

                        <a
                            href="https://github.com/gvsrusa"
                            target="_blank"
                            rel="noreferrer"
                            className="group flex justify-center items-center gap-2 px-8 py-4 glass-panel rounded-full text-white hover:bg-white/10 transition-all w-full sm:w-auto"
                        >
            ...
            {/* Scroll Indicator */}
            <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce opacity-50 z-20">
